...
namespace Plugin
{
	...
	public static class CARDSTrackingPlugin
	{
		...
		public unsafe delegate bool Detect(ref Frame frame, ref Frame frameBackground, ref RectStruct zoneDetection, Target* targets, ref int nbTarget, int maxTarget, int mode);
